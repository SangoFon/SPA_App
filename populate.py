...
# add past meetings
meeting=Reservation(id=9,title='past meeting',teamId=3,roomId=2,bookerId=2,date=datetime(2018,2,15),startTime=10,endTime=14,duration=4)
...
# add past meetings
meeting=Reservation(id=15,title='future meeting1',teamId=3,roomId=2,bookerId=2,date=datetime(2018,3,15),startTime=11,endTime=14,duration=3)
db.session.add(meeting)
...
meeting=Reservation(id=16,title='future meeting2',teamId=6,roomId=3,bookerId=6,date=datetime(2018,3,15),startTime=10,endTime=13,duration=3)
db.session.add(meeting)
...
meeting=Reservation(id=17,title='future meeting3',teamId=6,roomId=3,bookerId=6,date=datetime(2018,3,15),startTime=15,endTime=19,duration=4)
db.session.add(meeting)
